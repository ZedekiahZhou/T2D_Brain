...
# ====================================================================================================
# Author:   Aaron
# Function: WGCNA for Hippocampus
...
#for (mytissue in tname) {
    ...
    # Plot the results:
    #sizeGrWindow(9, 5)
    pdf(file = paste0("../../../4.plots/WGCNA_Hippocampus/softpower_",mytissue,".pdf"), width = 9, height = 5);
    par(mfrow = c(1,2));
    cex1 = 0.9;
    ...
    pdf(file = paste0("../../../4.plots/WGCNA_Hippocampus/DendroColor_",mytissue,".pdf"), width = 12, height = 8);
